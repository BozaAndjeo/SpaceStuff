...
public class MainWindow extends javax.swing.JFrame {
    ...
    LinkedList <JLabel> bulletLabels=new LinkedList <JLabel>();
    
    Help h1=new Help();
    
    boolean keyPressed=false;
    LinkedList <String> pressedKeyCodes=new LinkedList <String>();
    
    double bigPictureWidth=5200;
    double bigPictureHeight=2500;
    
    double pictureModifier;
    
    int screenWidth;
    int screenHeight;
    
    int moveableBackgroundWidth;
    int moveableBackgroundHeight;
